...
export default function GuestFlowFrame({ eyebrow, title, description, children }: GuestFlowFrameProps) {
  return (
    <section className="min-h-screen bg-sera-surface-light pb-20 pt-32">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 md:px-6">
        ...
        >
          ...
          <h1 className="sera-heading text-4xl text-sera-navy md:text-6xl">{title}</h1>
          <p className="sera-body max-w-2xl text-base text-sera-warm-grey md:text-lg">{description}</p>
        </motion.div>
