...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center sera-gradient-navy overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-32">
        ...
        >
          A premium platform for creating, hosting, and managing modern events — from invitation design to night-of operations.
        </motion.p>
        ...
        >
          ...
          <Button variant="sera-outline" size="xl" asChild>
            <Link to="/platform" className="border-sera-sand text-sera-sand hover:bg-sera-ivory hover:text-sera-navy">
              View Platform
            </Link>
          </Button>
        </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-sera-surface-light to-transparent" />
    </section>
  );
}
