...
const ops = [
  ...
  },
  {
    icon: Smartphone,
    title: "VIP check-in",
    desc: "Fast credentials support return guests and VIP entry moments without adding friction.",
  ...
  },
  {
    icon: Beer,
    title: "Bar Ledger",
    desc: "Drink ticket redemptions update immediately at every service station.",
    metric: "347 redeemed",
    state: "Syncing",
  },
  {
