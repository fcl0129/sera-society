...
export default function BackgroundShell({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen bg-sera-canvas text-sera-ivory">
      {/* Optional: subtle film grain + soft vignette */}
      <div aria-hidden="true" className="pointer-events-none fixed inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(1400px_900px_at_50%_50%,transparent_55%,rgba(0,0,0,0.55))] opacity-70" />
      </div>
