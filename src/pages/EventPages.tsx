...
export default function EventPages() {
  ...
  return (
    <ThemeWrapper theme={theme} backgroundImage={backgroundImage}>
      ...
      <main className="mx-auto max-w-6xl space-y-8 px-4 pb-12 md:space-y-10 md:px-10 md:pb-16">
        <EventHero
          ...
          location="The Wythe Atrium, Brooklyn"
          dateTimeLabel="Saturday, July 12 · 7:30 PM"
          hostLine="Hosted by Sera Society, with an evening of music and private tastings."
        />
        ...
        <div className="grid items-start gap-5 md:grid-cols-[1.25fr_.75fr]" id="details">
          <section className="rounded-[2rem] border border-white/35 bg-white/12 p-6 backdrop-blur-sm md:p-8" id="schedule">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-[var(--event-text-secondary)] md:text-base">
              Join us for a one-night salon inspired by old-world hosting and contemporary nightlife. Expect immersive sound, intimate lighting,
              and a composed flow from arrival through final toast.
            </p>
          </section>
