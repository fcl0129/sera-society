          ...
          {view === "login" && (
            <>
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <Button variant="sera-ivory" size="lg" className="w-full" type="submit">Continue</Button>
              </form>
          ...
          {view === "forgot" && !forgotSent && (
            <>
              ...
              <form onSubmit={handleForgot} className="space-y-5">
                ...
                <Button variant="sera-ivory" size="lg" className="w-full" type="submit">Send Reset Link</Button>
              </form>
            </>
          )}
